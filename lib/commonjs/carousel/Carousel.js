...
class Carousel extends _react.default.Component {
  constructor(props) {
    ...
    _defineProperty(this, "_lastScrollOffset", void 0);
  ...
  _snapToItem(index) {
    ...
    this._currentScrollOffset = offset; // On both platforms, `onMomentumScrollEnd` won't be triggered if the scroll isn't animated
  ...
  render() {
    ...
    return this._needsScrollView() || !_reactNative.Animated.FlatList ?
    /*#__PURE__*/
    ...
    _react.default.createElement(ScrollViewComponent, props, this._getCustomData().map((item, index) => {
